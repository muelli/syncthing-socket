    ...
    doLast {
        ...
        try {
            exec {
                ...
                commandLine(cmd, "bind", "-target=android", "-androidapi", "26", "-v", "-trimpath", "-ldflags=-s -w -checklinkname=0", "-o", outputAar.absolutePath, "github.com/muelli/syncthing-socket/mobile")
