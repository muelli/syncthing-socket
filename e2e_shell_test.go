...
func TestShellP2P(t *testing.T) {
	...
	cmdServer := exec.Command("./test-shell-binary", "server", "--seed", passphrase, "--shell", "--direct-port", "22002", "--discovery", "", "--relay", "", "--log-level", "debug", "--log-format", "text")
	...
	cmdClient := exec.Command("./test-shell-binary", "client", "--seed", passphrase, "--shell", "--relay", "tcp://127.0.0.1:22002", "--discovery", "", "--log-level", "debug", "--log-format", "text")
