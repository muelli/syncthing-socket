...
func TestSocksProxyE2E(t *testing.T) {
	...
	// 2. Start server
	cmdServer := exec.Command("./test-syncthing-socket", "server", "--seed", passphrase, "--socks", "--direct-port", "22001", "--relay", "", "--discovery", "", "--log-level", "debug", "--log-format", "text")
	...
	cmdClient := exec.Command("./test-syncthing-socket", "client", "--seed", passphrase, "--relay", "tcp://127.0.0.1:22001", "--discovery", "", "--socks", "127.0.0.1:10800", "--log-level", "debug", "--log-format", "text")
